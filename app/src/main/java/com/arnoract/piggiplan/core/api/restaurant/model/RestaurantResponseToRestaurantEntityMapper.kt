...
object RestaurantResponseToRestaurantEntityMapper : Mapper<RestaurantsResponse, RestaurantEntity> {
    override fun map(from: RestaurantsResponse): RestaurantEntity {
